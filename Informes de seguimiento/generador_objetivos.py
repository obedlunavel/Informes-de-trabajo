...
def generar_nuevos_objetivos(expediente, campos_modificados):
    ...
    # 🔍 Depuración: Verificar actualización
    print(f"📌 Nuevos objetivos generados: {campos_modificados['nuevos_objetivos']}")
...
def actualizar_nuevos_objetivos(expediente, campos_modificados):
    ...
    # 🔍 Depuración
    print(f"📌 Nuevos objetivos actualizados dinámicamente: {campos_modificados['nuevos_objetivos']}")
